    ...
    <form method="POST" action="#">
        ...
        <div class="row datos1">
            <div class="form-group col-4">
                ...
                <input disabled class="form-control" name="txt_num_empleado" value="<?php echo $numero_empleado; ?>" type="text">
            </div>
            <div class="form-group col-4">
                <label for="txt_usuario">Usuario</label>
                <input class="form-control" name="txt_usuario" type="text" disabled value="<?php echo $usuario; ?>">
            </div>
            <div class="form-group col-4">
        ...
        <div class="form-group col-12">
            ...
            <input class="form-control" n ame="txt_num_empleado" type="text" disabled value="<?php echo $nombre; ?>">
        </div>

        <div class="row">
            <div class="form-group col">
                <label class="requiried" for="txt_IMEI">*IMEI</label>
                <input class="form-control" name="txt_IMEI" type="text">
            </div>
            <div class="form-group col">
